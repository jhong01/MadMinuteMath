...
public class SeekBarPreference extends Preference implements OnSeekBarChangeListener {
	...
	protected void updateView(View view) {
		...
		try {
			mStatusText = (RobotoTextView) view.findViewById(R.id.seekBarPrefValue);
			...
			RobotoTextView unitsRight = (RobotoTextView)view.findViewById(R.id.seekBarPrefUnitsRight);
			unitsRight.setText(mUnitsRight);
			
			RobotoTextView unitsLeft = (RobotoTextView)view.findViewById(R.id.seekBarPrefUnitsLeft);
